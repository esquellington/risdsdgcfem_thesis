#ifndef S2_DS_DSH_LEAF_FEM_SOLID2D_SIMPLIFIED_H
#define S2_DS_DSH_LEAF_FEM_SOLID2D_SIMPLIFIED_H

#include <Saphyre2/ds/dsh/GLeafDSH_Model.h>

#include <Saphyre2/ms/ParticleSystem.h>
//#include <Saphyre2/ms/fem/TriangleElement2.h>
...
class LeafDSH_FEM_Solid2D_Simplified: public GLeafDSH_Model< ms::ParticleSystem2D >
{
public:
    typedef geo::MeshSolidShape2 geo_shape_type;
    typedef geo::GObjectES<geo_shape_type> geo_object_type;
    enum EConstants {
        cNumEigenValues = 1 //TEMP: unused
    };

public:
    LeafDSH_FEM_Solid2D_Simplified( uint32 uid, IDynamicSystemHierarchy *p_parent );
    ~LeafDSH_FEM_Solid2D_Simplified();
...
#endif
    {
        LeafDSH_FEM_Solid2D_Simplified *m_pDSH;
        ...
        struct FEM
        {
            ...
            enum EMethod { eMethod_Id = 0,
                           ...
                           cNumMethods };
            EMethod m_Method;
            enum ENodeCollapseMethod { eNCM_ToC = 0,
                                       eNCM_IHFSDM = 1,
                                       cNumNCM };
            ENodeCollapseMethod m_NCM;
        } m_FEM;
        //\todo ms::fem::Params m_FEM;
        ...
        inline Params( LeafDSH_FEM_Solid2D_Simplified *p_dsh = 0 )
        : m_pDSH(p_dsh)
          // Develop
        , m_bRun(true)
...
#define __USE_DEFAUT_SCALE_1M
        ...
        static util::ArchetypeLibrary s_LeafDSH_FEM_Solid2D_Simplified_Params_ArchetypeLibrary; //TEMP:
#endif
...
private:
    ...
    void Step_ImplicitEuler( Real dt );
    //void Solve_ImplicitMidpoint( Real dt );
    //void Solve_Newmark( Real dt );
...
private:
    ...
    enum EDDF { eDraw_Nothing        = 0,
                ...
                eDraw_CoM            = 1<<4,
                eDraw_Contacts       = 1<<5,
                eDraw_Eigenbasis     = 1<<6,
                eDraw_Forces         = 1<<7,
                eDraw_Trajectory     = 1<<8,
                eDraw_DED            = 1<<9,
                eDraw_Everything     = 0xFFFFFFFF,
                eDraw_Default        = eDraw_Mesh | eDraw_KNC | eDraw_Contacts /*| eDraw_Degenerate | eDraw_Corotational | eDraw_CoM | eDraw_Eigenbasis */  | eDraw_Forces | eDraw_Trajectory | eDraw_DED
    };
    Flags32 m_DDF;
...
private:
    struct Stats
    {
        ...
        void Begin() { /* m_Num_Degenerate = 0; m_Sum_Degenerate_DetF = 0; */ m_SolverLS_NumIter = 0; m_SolverLS_Prec = 0; /*statician.Clear();*/ }
        void End() { /*statician.End();*/ }
    };
...
#endif // S2_DS_DSH_LEAF_FEM_SOLID2D_SIMPLIFIED_H
