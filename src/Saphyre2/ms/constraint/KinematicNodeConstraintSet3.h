#ifndef S2_MS_CONSTRAINT_KINEMATIC_CONSTRAINT_SET_3_H
#define S2_MS_CONSTRAINT_KINEMATIC_CONSTRAINT_SET_3_H
...
class KinematicNodeConstraintSet3
{
public:
    struct KNC;
...
public:
    KinematicNodeConstraintSet3()
    : m_poolKNC(16)
        {}
    ~KinematicNodeConstraintSet3() {}

    knc_id_type AddKNC( unsigned int nid, const Vec3 &pos, const Vec3 &vel )
        {
    ...
    void ResetKNC( knc_id_type kncid, const Vec3 &pos, const Vec3 &vel )
        {
    ...
    void SetPosKNC( knc_id_type kncid, const Vec3 &pos )
        {
            MS_ASSERT( m_poolKNC.IsValid(kncid) );
            kncid->m_Pos = pos;
            kncid->m_Type = KNC::eKNCT_Position;
    ...
    void SetVelKNC( knc_id_type kncid, const Vec3 &vel )
        {
            MS_ASSERT( m_poolKNC.IsValid(kncid) );
            kncid->m_Vel = vel;
...
#endif //S2_MS_CONSTRAINT_KINEMATIC_CONSTRAINT_SET_3_H
