#ifndef S2_MS_FEM_TRIANGLE_ELEMENT_2_H
#define S2_MS_FEM_TRIANGLE_ELEMENT_2_H
...
typedef mal::GMat<Real,6,3> Mat6x3;
...
*/
class TriangleElement2
{
public:
    inline TriangleElement2() : m_K(Real(0)) {}
...
public:
    ...
    static void Compute_D( const Vec2 &r0, const Vec2 &r1, const Vec2 &r2, Mat2x2 &D )
        {
            D(0,0) = r1.x() - r0.x(); D(0,1) = r2.x() - r0.x();
            D(1,0) = r1.y() - r0.y(); D(1,1) = r2.y() - r0.y();
        }
    ...
    // Compute plasticity matrix P so that elastic_force = P * plastic_strain
    static void Compute_P( const Vec2 &r0, const Vec2 &r1, const Vec2 &r2,
                           Real young_modulus, Real poisson_ratio,
                           //Real plastic_yield, Real plastic_max, Real plastic_creep,
                           Mat6x3 &P )
        {
            Mat3x6 B;
            Real area = Compute_B( r0, r1, r2, B );
...
#endif //S2_MS_FEM_TRIANGLE_ELEMENT_2_H
