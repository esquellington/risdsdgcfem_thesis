#ifndef GEO_EMBEDDING_V2INT2BEDFE_H
#define GEO_EMBEDDING_V2INT2BEDFE_H
...
*/
class Vertices2_In_Triangles2_BEDF_Embedding: public IEmbedding
{
public:
...
public:
    Vertices2_In_Triangles2_BEDF_Embedding() : m_NumTEVS(0), m_NumEmbeddedVID(0), m_vecTEVS(0), m_vecEmbeddedVID(0) {}
    ~Vertices2_In_Triangles2_BEDF_Embedding() { ClearBakedData(); }
...
class Editable_Vertices2_In_Triangles2_BEDF_Embedding: public Vertices2_In_Triangles2_BEDF_Embedding
{
public:
    Editable_Vertices2_In_Triangles2_BEDF_Embedding() : m_allocTEVS(0), m_allocEmbeddedVID(0) {}
    ~Editable_Vertices2_In_Triangles2_BEDF_Embedding() { Clear(); }
...
#endif //GEO_EMBEDDING_V2INT2BEDFE_H
